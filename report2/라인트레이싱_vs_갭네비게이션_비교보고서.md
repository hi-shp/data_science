...
그림 3과 그림 4의 단독 궤적 맵은 성공 궤적(에메랄드 그린/네온 시안선)과 충돌 실패 궤적(타오르는 핫 레드 붉은선)을 극명한 색상 대비로 분리 표출하여 각 알고리즘이 어느 지점에서 실패하는지를 직관적으로 보여주며, 도착 지점 역시 원형(Circle) 타겟 마커로 명확하게 표시되었습니다.
