...
def generate_subfig3():
    ...
    ax3.annotate('', xy=(5.0, 2.8), xytext=(4.0, 2.8),
                 arrowprops=dict(arrowstyle='<->', color='#DC2626', lw=1.2), zorder=10)
    ax3.text(5.08, 2.8, "안전마진 0.5m", ha='left', va='center', fontsize=9.8, fontweight='bold', color='#DC2626')
...
def generate_sheet_1():
    ...
    ax3.annotate('', xy=(5.0, 2.8), xytext=(4.0, 2.8),
                 arrowprops=dict(arrowstyle='<->', color='#DC2626', lw=1.2), zorder=10)
    ax3.text(5.08, 2.8, "안전마진 0.5m", ha='left', va='center', fontsize=9.2, fontweight='bold', color='#DC2626')
